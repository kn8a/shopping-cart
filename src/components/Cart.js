...
const Cart = (props) => {
  ...
  const checkout = () => {
    alert(
      `Your purchase in the amount of $${cartTotal} would have been greatly appreciated, however, this isn't a real store, and the products here aren't real. Thank you for visiting this fake store.`
    );
  };
